...
/// Unique id generated by the composer so the projector can correlate
/// a response back to its originating request even when the same gate
/// fires multiple times within a single run.
/// </param>
/// <param name="RequestId">
/// The MAF ExternalRequest.RequestId generated when the gate fired.
/// The dispatcher uses this for out-of-order response routing
/// instead of a FIFO queue per gate.
/// </param>
